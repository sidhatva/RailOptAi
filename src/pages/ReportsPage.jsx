          ...
          <div className="h-64 sm:h-72 w-full min-w-0 relative">
            <ResponsiveContainer width="100%" height="100%" debounce={50}>
              <BarChart data={blockHoursTrend} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Bar dataKey="aiOptimizedGranted" name="RailOpt AI Granted" fill="#10B981" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
          ...
          <div className="h-64 sm:h-72 w-full min-w-0 relative">
            <ResponsiveContainer width="100%" height="100%" debounce={50}>
              <LineChart data={punctualityDelaySavings} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                ...
                <Line type="monotone" dataKey="aiAssistedDelayMins" name="RailOpt AI Delays" stroke="#10B981" strokeWidth={2.5} dot={{ r: 4 }} />
