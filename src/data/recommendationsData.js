export const aiRecommendations = [
  {
    ...
    description: "SSE/TRD and SSE/P-Way have submitted separate block requests for the same physical track segment within 36 hours. RailOpt AI recommends bundling into a single 3.5 hour Integrated Traffic & Power block.",
    metrics: {
      blockHoursSaved: 2.5,
